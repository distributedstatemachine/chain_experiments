//! Minimal SHA-256 implementation for block hashes and the random oracle.
...
pub fn meets_difficulty(hash: &[u8; 32], difficulty_bits: u32) -> bool {
    difficulty_bits <= 256 && leading_zero_bits(hash) >= difficulty_bits
}
...
mod tests {
    ...
    #[test]
    fn difficulty_counts_prefix_bits() {
        let hash = [
