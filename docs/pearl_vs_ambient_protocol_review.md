...
- `pearl.pdf`: "Proofs of Useful Work from Arbitrary Matrix Multiplication" by Ilan Komargodski and Omri Weinstein. I refer to it as **Pearl** below.
- `Ambient_Litepaper_V1.pdf`: "Ambient Litepaper V1". I refer to it as **Ambient** below.
