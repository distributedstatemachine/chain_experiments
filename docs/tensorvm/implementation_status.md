...
test that starts the mandatory libp2p service path and serves authenticated `/health`, `/chain/head`,
`/explorer`, `/faucet/page`, and `/telemetry/dashboard` from the process-level service.
