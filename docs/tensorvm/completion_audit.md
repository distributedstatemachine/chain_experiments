...
| TensorVM line coverage | [`tarpaulin_report.md`](tarpaulin_report.md) records 100.00% `tensor_vm` crate line coverage, 7905/7905 lines covered | Passed |
...
reject whitespace-padded field keys, reject whitespace-padded repeated-record and preflight service values,
