...
| `cargo tarpaulin` | [`tarpaulin_report.md`](tarpaulin_report.md) records 234 instrumented library tests | Passed |
| TensorVM line coverage | [`tarpaulin_report.md`](tarpaulin_report.md) records 100.00% `tensor_vm` crate line coverage, 9666/9666 lines covered | Passed |
...
| 4 | Blocks are produced by validators winning useful-verification PoW over deterministic settled-receipt blockspace | Current tests cover the superseded settled-TensorWork proposer path, not v2 useful-verification PoW | Not complete |
