...
- the public evidence bundle must include a signed wall-clock run window, signed node heartbeats,
  ...
  records, and signed deployed-service content-root records bound to external HTTPS URLs
...
signed service-health records bound to external HTTPS URLs and matching health paths, signed
