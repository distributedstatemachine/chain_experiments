...
| AC13 local preflight | [`public_testnet_preflight.md`](public_testnet_preflight.md), checked pending manifest [`public-testnet.preflight`](public-testnet.preflight), `parse_public_testnet_preflight_manifest`, checked health/content surface plans, and `tvmd public-testnet preflight --manifest <path>` | Present |
...
| `cargo test --workspace --release` | Latest iteration evidence records 14 `pearl_chain` and 171 `tensor_vm` tests | Passed |
