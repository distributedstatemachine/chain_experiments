...
Local evidence validators reject malformed HTTPS authorities, userinfo, whitespace, invalid ports,
localhost, private, link-local, documentation, shared-address, benchmarking, multicast, reserved, empty
publication endpoints, and malformed `ipfs://`/`ar://` identifiers, and they verify manifest publication
