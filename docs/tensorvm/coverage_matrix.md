...
- Public 7-day independent-node testnet evidence is not available in this repository; typed evidence
  ...
  malformed HTTPS authority rejection for public endpoints,
  ...
  libp2p network-observation CLI generation rejects non-public and single-label DNS multiaddrs, service health/content evidence
