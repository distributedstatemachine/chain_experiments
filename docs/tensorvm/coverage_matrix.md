...
- Public 7-day independent-node testnet evidence is not available in this repository; typed evidence
  ...
  runtime use with signed network-observation summary roots, and deployed public-service reachability bound
